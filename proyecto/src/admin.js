...
if (user.email !== "yisethvacamedina00@gmail.com") {
...
.select(`
  ...
  imagen,
  creado_en,
  estudiantes:estudiantes(id,nombre,correo),
  cursos:cursos(id,nombre)
`)
...
// Normalizamos: puede venir como
'estudiantes'/'estudiante'/'cursos'/'curso'
